        ...
        {mount && (
          <div className="mt-10 w-full flex flex-col items-center">
            ...
            >
              ...
              <h2 className="w-4/5 text-xl mt-5 opacity-50">{data.resume.description}</h2>
              <div className="mt-2">
                <Socials />
              </div>
              <div className="mt-5">
              ...
              <div className="mt-5">
                ...
                <div className="mt-2">
                  ...
                  <h3 className="text-sm opacity-75">{data.resume.education.universityDate}</h3>
                  <p className="text-sm mt-2 opacity-50">{data.resume.education.universityPara}</p>
                </div>
              </div>
              <div className="mt-5">
